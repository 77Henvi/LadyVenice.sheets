...
const TRANSLATIONS = {
  th: {
    ...
    'info.pricing.desc': 'ราคาที่แสดงในแคตตาล็อก<br><strong>ส่วนมากเป็น ขนาด L (ช่อใหญ่)</strong><br>สามารถปรับขนาดได้ S / M / L',    'info.custom': '* ราคาอาจแตกต่างตามขนาดและชนิดดอกไม้<br>(สามารถ Custom ได้)',
